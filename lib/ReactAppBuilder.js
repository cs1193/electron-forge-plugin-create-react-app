...
exports.readDefinesData = exports.createDefinesData = exports.lernaBootstrap = exports.toEnvironmentVariable = exports.copyBuildData = exports.craBuild = exports.installYarnModules = void 0;
...
function craBuild(projectDir, pathToPackage) {
    try {
        const packageDirPath = path_1.default.resolve(projectDir, pathToPackage);
        process.chdir(packageDirPath);
        cross_spawn_1.default.sync('PUBLIC_URL=.', ['yarn', 'build']);
        process.chdir(projectDir);
    }
    catch (e) {
        console.error(e);
...
exports.craBuild = craBuild;
function copyBuildData(projectDir, packageName, pathToPackage) {
    try {
        const tmpDir = path_1.default.join(projectDir, '.create-react-app', packageName, 'build');
...
function createDefinesData(projectDir, definesData) {
    try {
        const definesFile = path_1.default.join(projectDir, '.create-react-app', 'defines.json');
